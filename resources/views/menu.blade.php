            ...
            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                <div class="card border-primary cardMarginBottom">
                    <div class="card-body text-center">
                        ...
                        <a href="inspections" class="btn btn-outline-primary stretched-link">Link</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                <div class="card border-primary cardMarginBottom">
                    <div class="card-body text-center">
                        ...
                        <a href="customers" class="btn btn-outline-primary stretched-link">Link</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                <div class="card border-primary cardMarginBottom">
                    <div class="card-body text-center">
                        ...
                        <a href="systemUsers" class="btn btn-outline-primary stretched-link">Link</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-10 col-sm-8 col-md-6 col-lg-4">
                <div class="card border-primary">
                    <div class="card-body text-center">
                        ...
                        <a href="aboutUs" class="btn btn-outline-primary stretched-link">Link</a>
                    </div>
                </div>
            </div>
        </div>
